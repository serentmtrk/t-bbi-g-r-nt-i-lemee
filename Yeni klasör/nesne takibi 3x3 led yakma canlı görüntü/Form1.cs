        ...
        public void nesnebul(Bitmap image)
        {
            ...
            foreach (Rectangle recs in rects)
            {
                if (rects.Length > 0)
                {
                    ...
                    if (objectX <= 100 && objectY <= 100)
                    {
                        ardino.Write("1");
                    }
                    else if (objectX <= 200 && objectX > 100 && objectY <= 100)
                    {
                        ardino.Write("2");
                    }
                    else if (objectX > 200 && objectY <= 100)
                    {
                        ardino.Write("3");
                    }
                    else if (objectX <= 100 && objectY > 100 && objectY <= 200)
                    {
                        ardino.Write("4");
                    }
                    else if (objectX <= 200 && objectX > 100 && objectY > 100 && objectY <= 200)
                    {
                        ardino.Write("5");
                    }
                    else if (objectX > 200 && objectY > 200)
                    {
                        ardino.Write("6");
                    }
                    else if (objectX <= 100 && objectY > 200)
                    {
                        ardino.Write("7");
                    }
                    else if (objectX <= 200 && objectX > 100 && objectY <= 200)
                    {
                        ardino.Write("8");
                    }
                    else if (objectX > 200 && objectY > 200)
